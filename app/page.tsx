...
export default function Page() {
  return (
    <main className="flex min-h-screen flex-col p-6">
      ...
      {/* Konten utama */}
      <div className="mt-4 flex grow flex-col gap-8 md:flex-row md:items-center">
        
        {/* Bagian teks kiri */}
        <div className="flex flex-col justify-center gap-6 rounded-lg bg-gray-50 px-6 py-10 md:w-2/5 md:px-12">
          <h1
            className={`${lusitana.className} text-2xl font-bold text-gray-900 md:text-4xl md:leading-snug`}
          >
            Welcome to Acme Dashboard
          </h1>
          <p className="text-base text-gray-600 md:text-lg">
            Kelola keuangan, pantau invoices, dan jelajahi fitur Next.js modern.
          </p>
